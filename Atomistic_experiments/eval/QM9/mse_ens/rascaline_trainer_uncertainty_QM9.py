...
from nn.loss import EnergyForceLoss, GeneralLoss, EnergyForceUncertaintyLoss, CRPS
...
class BPNNRascalineModule(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 model = BPNNModel(
                 interaction=BPNNInteraction(n_out=1, 
                                             n_hidden= 256,
                                             n_hidden_layers = 3,
        ...
        self.loss_fn = loss_fn(base_loss=torch.nn.MSELoss)
