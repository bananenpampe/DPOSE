...
ckpts = glob.glob("../mse_ensemble/*/*/*/*/*.ckpt")

# --- define the hypers ---
frames_water_train = ase.io.read("../../data/LiPS_train.xyz",":")
frames_water_val = ase.io.read("../../data/LiPS_val.xyz", ":")
frames_water_test = ase.io.read("../../data/LiPS_test.xyz", ":")
...
wandb_logger = WandbLogger(project="eval-LiPS",log_model=True)
...
for module in modules:
    print(module.state_dict()["model.interaction.model.m_map.LabelsEntry(species_center=16).mean_out.weight"])
