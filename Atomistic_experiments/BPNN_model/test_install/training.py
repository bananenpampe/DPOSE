...
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "H2O", "model"))
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), "..",  "H2O", "utils"))
...
# --- define the hypers ---
frames_water_train = ase.io.read("../../data/BaTiO3/train.xyz",":10")
frames_water_val = ase.io.read("../../data/BaTiO3/val.xyz", ":10")
frames_water_test = ase.io.read("../../data/BaTiO3/test.xyz", ":10")
...
checkpoint = torch.load(os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "..","eval","BaTiO3","shallow_ens_NLL","example.ckpt") )['state_dict']
