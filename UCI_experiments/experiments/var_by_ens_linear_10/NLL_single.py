...
for name, load_f in all_data.items():
    ...
    for i in range(n_split):
        ...
        NN_KWARGS = dict(n_in=size_dat, n_out=Ytrain.shape[-1], n_hidden=n_hidden,n_hidden_layers=1,activation=torch.nn.ReLU, n_linear_out=10)
        ...
        #input: torch.Tensor, target: torch.Tensor, var: torch.Tensor
