...
model_shallow, loss_curve_shallow_ens_NLL = fit_model_NLL(x,y,nn=MLP_mean_var ,\
                    model_kwargs=NN_KWARGS,solver=torch.optim.Adam,\
                    solver_kwargs=SOLVER_KWARGS,training_kwargs=TRAINING_KWARGS, loss=CPRS)
